...
$con = new BD();
$objUser = $con->findAll2("SELECT * FROM usuarios WHERE id = " . $_POST['id_perfil'] . "");
$con->desconectar();
?>
<!DOCTYPE html>
<html>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="Model/imageProfile.php?idUser=<?php echo $objUser[0]['id']; ?>" class="img-circle" alt="User Image" />
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="timeline">
                                ...
                                <li class="time-label">
                                    <span class="bg-red">
                                        Ultima Modificacion: <?php echo $objUser[0]['update_at'] ?>
                                    </span>
                                </li>
                                <!-- /.timeline-label -->
                                <!-- timeline item -->
                                <li>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-body" id="portada">                                            
                                                <img src="Model/imagePortada.php?idUser=<?php echo $objUser[0]['id']; ?>" />                                            
                                        </div>
